function [w,q,k,qs,ks,best] = train(Parameter,net,train_data,train_target)
%% parameter input
F = Parameter.F;
CR = Parameter.CR;
...
q = best_population(J*M+1:D-3);

        k =  best_population(D-2);
        qs =  best_population(D-1);
        ks =  best_population(D);
